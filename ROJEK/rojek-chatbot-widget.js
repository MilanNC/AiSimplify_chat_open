...
(function() {
    ...
    const CLIENT_ID = 'ROJEK';
    const ASSISTANT_NAME = 'Evžen';
    
    // Barvy a vzhled
    const BRAND_GRADIENT = 'linear-gradient(90deg, #FBDD00, #000000)'; // Hlavní gradient pro hlavičku a ikony - fialová do černé
    const PRIMARY_COLOR = '#FBDD00'; // Hlavní fialová barva pro zvýraznění a UI prvky
    const USER_BUBBLE_COLOR = '#FBDD00'; // Barva pozadí pro bubliny uživatelských zpráv
    const ASSISTANT_BUBBLE_COLOR = '#f0f0f5'; // Světle šedá barva pro bubliny zpráv asistenta
    const USER_BUBBLE_TEXT_COLOR = '#000000'; // Barva textu v uživatelských bublinách (bílá na fialovém pozadí)
    ...
    // Avatar a obrázky
    const AVATAR_URL = 'https://static.wixstatic.com/media/ae7bf7_a582038f3fff4fbaba6db0a86c3c21ab~mv2.png';
    
    // Úvodní zpráva asistenta
    const INITIAL_MESSAGE = 'Ahoj! Jsem Evžen, váš AI asistent. Toto je zatím nenakonfigurovaný AI chatbot, bez instrukcí a se znalostní bází zatím sdílenou s Áďou(kotle), ale funguje 😉';
